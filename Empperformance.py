2'''Implement any one of the following Expert System
...
for i in range(0,n):
    ...
    data={
        ...
        "expectations_exceeded": bool(int(input("Enter the performance of expectations exceeded in termsof 0 or 1: "))),
